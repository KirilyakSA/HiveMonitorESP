...
> Этот документ описывает целевое ТЗ backend и будущие инкременты продукта. Текущее состояние реализации и известные расхождения с firmware/backend зафиксированы в [../../docs/implementation-status.md](../../docs/implementation-status.md).
