...
values
    ...
    (
        '55555555-5555-5555-5555-555555555562'::uuid,
        '33333333-3333-3333-3333-333333333331'::uuid,
        'demo-unassigned-010',
        'hive_monitor',
        'unassigned',
    ...
    (
        '55555555-5555-5555-5555-555555555563'::uuid,
        '33333333-3333-3333-3333-333333333331'::uuid,
        'demo-unassigned-011',
        'hive_monitor',
        'unassigned',
...
with unassigned_samples as (
    ...
    from (values
        ...
        (
            '55555555-5555-5555-5555-555555555562'::uuid,
            24.8::double precision,
            28.7::double precision,
            62.0::double precision,
            88.0::double precision
        ),
        (
            '55555555-5555-5555-5555-555555555563'::uuid,
            39.2::double precision,
            27.9::double precision,
            68.0::double precision,
