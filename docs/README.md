...
| --- | --- | --- |
| `firmware/` | Прошивки ESP8266/ESP32 и локальный web-интерфейс устройства | [Firmware](subprojects/firmware/README.md) |
| `backend/` | Go backend, API, обработка телеметрии и уведомлений | [Backend](subprojects/backend/README.md) |
| `web/` | Web-интерфейс системы на React + TypeScript + Vite | [Web](subprojects/web/README.md) |
| `mobile/` | Мобильные приложения Android/iOS на React Native + TypeScript | [Mobile](subprojects/mobile/README.md) |
| `deploy/` | Docker-first развертывание backend, PostgreSQL и MQTT broker | [Deploy](subprojects/deploy/README.md) |
